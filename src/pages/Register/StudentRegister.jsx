...
function StudentRegister() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Form validation
      if (!formData.name || !formData.sid || !formData.department || 
      ...
      // 2. Store student data in Firestore
      const studentData = {
          ...
          <div className="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5">
            <div className="card border-0 shadow-lg rounded-4">
              ...
              <div className="card-header bg-success bg-gradient text-white text-center py-4 border-0 rounded-top-4">
                <h2 className="h4 mb-2">Student Registration</h2>
                ...
                <form onSubmit={handleSubmit} className="needs-validation">
                  ...
                  <div className="form-floating mb-3">
                    <input
                      ...
                      required
                    />
                    <label htmlFor="sid" className="d-flex align-items-center">
                      <FaIdCard className="me-2 text-success" /> Student ID
                    </label>
                  </div>
                  ...
                  <div className="form-floating mb-3">
                    ...
                    <label htmlFor="department" className="d-flex align-items-center">
                      <FaBuilding className="me-2 text-success" /> Department
                    </label>
                  </div>
                  ...
                  <div className="form-floating mb-3">
                    ...
                    <label htmlFor="course" className="d-flex align-items-center">
                      <FaBook className="me-2 text-success" /> Course
                    </label>
                  </div>
                  ...
                  <div className="form-floating mb-3">
                    ...
                    <label htmlFor="email" className="d-flex align-items-center">
                      <FaEnvelope className="me-2 text-success" /> Email Address
                    </label>
                  </div>
                  ...
                  <div className="form-floating mb-4">
                    ...
                    <label htmlFor="password" className="d-flex align-items-center">
                      <FaLock className="me-2 text-success" /> Password
                    </label>
                  </div>
              ...
              <div className="card-footer text-center py-3">
                <p className="mb-0">
                  ...
                  <button className="btn btn-link text-decoration-none" onClick={() => navigate('/student-login')}>
                    Click here to login
                  </button>
                </p>
              </div>
